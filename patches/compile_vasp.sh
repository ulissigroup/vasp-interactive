...
# INTERACTIVE_PATCH: if set and not empty, apply the interactive patch (as a single py file)
...
# LIBBEEF: if set and not empty, link libbeef to VASP (e.g. /opt/libbeef)
##########################################################################
